...
class PenghargaanController extends Controller
{
    ...
    public function insert(Request $request)
    {
        ...
        $insert = Penghargaan::insert($request);
    ...
    // Edit Penghargaan
    public function edit(Request $request, $id_penghargaan)
    {
        // Validation
        $messages = [
            "required" => ":attribute harus diisi!"
        ...
        $edit = Penghargaan::edit($request, $id_penghargaan);
    ...
    public function delete($id_penghargaan)
    {
        ...
        $delete = Penghargaan::deletePenghargaan($id_penghargaan);
