    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                // Add borders
                $event->sheet->getStyle('A6:F64')->applyFromArray([
                    'alignment' => [
                ...
                $event->sheet->getStyle('A27:F28')->applyFromArray([
                 'fill' => [
                ...
                $event->sheet->getStyle('A35:F37')->applyFromArray([
                    'fill' => [
                        'fillType' => Fill::FILL_SOLID,
                        'color' => [
                            'argb' => 'FFe69d30'
                ...
                $event->sheet->getStyle('A47:F48')->applyFromArray([
                    'fill' => [
                        'fillType' => Fill::FILL_SOLID,
                        'color' => [
                            'argb' => 'FFe69d30'
                ...
                $event->sheet->getStyle('A58:F59')->applyFromArray([
                    'fill' => [
                        'fillType' => Fill::FILL_SOLID,
                        'color' => [
                            'argb' => 'FFe69d30'
