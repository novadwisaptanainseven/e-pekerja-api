...
class RiwayatGolonganExport implements FromView, ShouldAutoSize, WithEvents, WithDrawings
{
    ...
    {
        return view('exports.riwayat-golongan', [
            'data' => RiwayatGolongan::get($this->id),
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $title = "Riwayat Golongan Pegawai Negeri Sipil";
